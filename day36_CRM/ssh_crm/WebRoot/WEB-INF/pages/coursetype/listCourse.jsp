...
<%--条件查询 start --%>
<s:form action="courseTypeAction_findAll.action" namespace="/">
	...
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  ...
	  <tr>  
	    <td>总学时：</td>
	    <td>
	    	<s:textfield  name="totalStart" size="12"></s:textfield> 至  
	  ...
	  <tr>
	    <td>课程费用：</td>
	    <td>
	    	<s:textfield name="courseCostStart" size="12"></s:textfield>  至  
    ...
    <td align="right">
        ...
        <span>
	        <s:if test="#pageBean.pageNum gt 1">
	            ...
	            <a href="javascript:void(0);" onclick="showPage(${pageBean.pageNum - 1})">[上一页]</a>&nbsp;&nbsp;
	         </s:if>
	         ...
	         <s:if test="#pageBean.pageNum lt #pageBean.totalPage">
	            <a href="javascript:void(0);" onclick="showPage(${pageBean.pageNum + 1})">[下一页]</a>&nbsp;&nbsp;
	            <a href="javascript:void(0);" onclick="showPage(${pageBean.totalPage})">[尾页]</a>
        	</s:if>
        </span>
    </td>
  </tr>
